...
public class Cine {
    ...
    public void reservar() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Reservada! Asiento " + getSeatLabel(seleccionAsiento)
    ...
    public void modificar() {
        try {
            int sala = getValidInput("Digite el número de sala (1-" + salas + "):", 1, salas, false) - 1;
            ...
            JOptionPane.showMessageDialog(null, "Cancelada! Asiento " + (seleccionAsiento + 1)
    ...
    private int getValidEmployeeID() {
        int idEmpleado;
        do {
            idEmpleado = getValidInput("Digite su ID de empleado para la reserva:", 1, Integer.MAX_VALUE, false);
