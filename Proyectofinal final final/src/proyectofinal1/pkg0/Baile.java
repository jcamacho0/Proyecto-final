...
public class Baile {
    ...
    private static final String[] classHours = {"19:00", "20:00"}; //horarios de la clase
    ...
    private void reservar() {
        ...
        if (chooseSpace < 0 || chooseSpace >= espacios || reservas[clase][chooseSpace] != null) {
            JOptionPane.showMessageDialog(null, "El espacio no esta disponible.");
            return;
        }//fin del if
        ...
        if (empleado == null) {
            JOptionPane.showMessageDialog(null, "Empleado no esta válido.");
            return;
        }//fin del if

        //mostrar las opciones de horas disponibles
        String opcionesHoras = "Indique la hora de la reserva" + (clase + 1)
    ...
    private void modificar() {
        ...
        StringBuilder reservasActuales = new StringBuilder("Reservas para la clase de baile" + ":\n");
        ...
        int seleccion = JOptionPane.showOptionDialog(null, "Seleccione una:", "Reservas",
    ...
    private void modificarHoraReserva(int clase) {
        ...
        if (espacio < 0 || espacio >= espacios || reservas[clase][espacio] == null) {
            JOptionPane.showMessageDialog(null, "Selección de espacio no esta reservado.");
            return;
        }//fin de if
    ...
    private int obtenerNuevaHoraReserva() {
        ...
        while (seleccionHora < 0 || seleccionHora >= classHours.length) {
            JOptionPane.showMessageDialog(null, "Selección de hora no válida.");
    ...
    private void eliminarReserva(int clase) {
        int espacio = Integer.parseInt(JOptionPane.showInputDialog("Seleccione el espacio de borrar(1-" + espacios + "):")) - 1;
