...
public class Entrenador {
    ...
    private void reservar() {
        int entrenador = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el número del entrenador que desees(1-" + Entrenador.entrenadores + "):")) - 1;

        if (entrenador < 0 || entrenador >= Entrenador.entrenadores) {
            JOptionPane.showMessageDialog(null, "Número de entrenador no esta válido.");
            return;
        }//fin de if

        //mostrar horarios disponibles
        String opcionesHorarios = "Escoja un horario para el entrenador de gymnasio" + (entrenador + 1) + ":\n";
        ...
        if (seleccionHorario < 0 || seleccionHorario >= horarios || reservas[entrenador][seleccionHorario][0] != null) {
            JOptionPane.showMessageDialog(null, "Selección de horario no esta disponible.");
            return;
        }//if
        ...
        if (!validarEmpleado(idEmpleado)) {
            JOptionPane.showMessageDialog(null, "ID de empleado no esta válido.");
            return;
        }//if
        ...
        JOptionPane.showMessageDialog(null, "Reservada! Entrenador " + (entrenador + 1)
                + " a las " + "Horario " + (seleccionHorario + 14) + ":00 - " + (seleccionHorario + 15) + ":00 para la persona con ID " + idEmpleado + ".");
    }//fin de método

    private int mostrarOpciones() {
        String[] opcionesEdicion = {"Cancelar Reserva", "Modificar Horario", "Modificar Entrenador"};
        int select = JOptionPane.showOptionDialog(
                null,
                "Escoja una opción para su reserva:",
                "Editar Reserva",
    ...
    private void modificar() {
        // solicitar ID del empleado
        int idEmpleado = Integer.parseInt(JOptionPane.showInputDialog("Digite su ID de empleado para modificar la reserva:"));
        ...
        if (entrenador == -1 || horario == -1) {
            JOptionPane.showMessageDialog(null, "Error: No se encontró ninguna reserva para el ID de empleado.");
            return;
        }//if
    ...
    private void cambiarHorario(int entrenador, int horario) {
        //mostrar horarios disponibles
        String opcionesHorarios = "Indique un nuevo horario:\n";
        ...
        JOptionPane.showMessageDialog(null, "Reserva editada! Entrenador " + (entrenador + 1)
    ...
    private void cambiarEntrenador(int entrenador, int horario) {
        ...
        String opcionesEntrenadores = "Escoja otro entrenador para su reserva:\n";
        ...
        JOptionPane.showMessageDialog(null, "Reserva editada. Entrenador " + (nuevoEntrenador + 1)
